...
：</dt>
        ...
        <form name=tradequery action=alipay/pagepay/query.php method=post target="_blank">
...
：</dt>
        ...
        <form name=traderefund action=alipay/pagepay/refund.php method=post target="_blank">
...
：</dt>
        ...
        <form name=traderefundquery action=alipay/pagepay/refundquery.php method=post target="_blank">
...
：</dt>
        ...
        <form name=tradeclose action=alipay/pagepay/close.php method=post target="_blank">
...
：</dt>
    ...
    <br>
    <br><a target="" href="./alipay/f2fpay/barpay_test.php">当面付2.0  条码支付</a>
    <br><a target="" href="./alipay/f2fpay/qrpay_test.php">当面付2.0 二维码支付</a>
    <br><a target="" href="./alipay/f2fpay/query_test.php">当面付2.0  订单查询</a>
    <br><a target="" href="./alipay/f2fpay/refund_test.php">当面付2.0  订单退款</a>

    <br><a target="" href="./alipay/wappay/pay.php">手机网站2.0支付(接口名：alipay.trade.wap.pay)</a>
    <br><a target="" href="./alipay/wappay/query.php">手机网站2.0订单查询 (接口名：alipay.trade.query)</a>
    <br><a target="" href="./alipay/wappay/refund.php">手机网站2.0订单退款  (接口名：alipay.trade.refund)</a>
    <br><a target="" href="./alipay/wappay/refundquery.php">手机网站2.0订单退款查询(接口名：alipay.trade.fastpay.refund.query)</a>
    <br><a target="" href="./alipay/wappay/datadownioad.php">手机网站2.0账单下载(接口名：alipay.data.dataservice.bill.downloadurl.query)</a>
